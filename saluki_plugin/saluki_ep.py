...
entry-point discovery. The function constructs the plugin config schema (dict)
using the package-local dataset/model placeholders so the package remains fully
